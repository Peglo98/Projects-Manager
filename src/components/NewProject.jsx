...
export default function NewProject({onAdd, onCancel}) {
    ...
    function handleSave(){
        ...
        if (enteredTtile.trim() === '' || enteredDescription.trim() === "" || enteredDueDate.trim() === ''){
            modal.current.open();
            return;
        }
  ...
  return (
    ...
    <Modal ref={modal} buttonCaption="Close">
        ...
        <p className='text-stone-700 mb-4'>Oops... Looks like you forgot to provide all values.</p>
        <p className='text-stone-700 mb-4'>Please try again.</p>
    </Modal>
